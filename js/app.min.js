...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_popup_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/popup.js */ \"./src/js/modules/popup.js\");\n/* harmony import */ var _modules_checkbox_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/checkbox.js */ \"./src/js/modules/checkbox.js\");\n/* harmony import */ var apexcharts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! apexcharts */ \"./node_modules/apexcharts/dist/apexcharts.common.js\");\n\r\n(0,_modules_popup_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\n\r\n\r\n(0,_modules_checkbox_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\r\n\r\n// Высота вьюпорта устройства\r\nconst appHeight = () => {\r\n    const doc = document.documentElement;\r\n    doc.style.setProperty('--app-height', `${window.innerHeight}px`);\r\n}\r\nappHeight();\r\n\r\n\r\n\r\n// Дневные графики\r\nvar dailyChartOptions = {\r\n    series: [{\r\n        name: 'КОМАНДА',\r\n        data: [44, 55, 57, 56, 61, 58, 63]\r\n    }, {\r\n        name: 'ТИМЛИДЫ',\r\n        data: [76, 85, 101, 98, 87, 105, 91]\r\n    }, {\r\n        name: 'ТРЕЙДЕРЫ',\r\n        data: [35, 41, 36, 26, 45, 48, 52]\r\n    }],\r\n    chart: {\r\n        type: 'bar',\r\n        height: 250,\r\n        toolbar: {\r\n            show: false,\r\n        }\r\n    },\r\n    plotOptions: {\r\n        bar: {\r\n            horizontal: false,\r\n            columnWidth: '60%',\r\n        },\r\n    },\r\n    dataLabels: {\r\n        enabled: false\r\n    },\r\n    stroke: {\r\n        show: true,\r\n        width: 5,\r\n        colors: ['transparent']\r\n    },\r\n    xaxis: {\r\n        categories: ['МАРТ', 'АПРЕЛЬ', 'МАЙ', 'ИЮНЬ', 'ИЮЛЬ', 'АВГУСТ', 'СЕНТЯБРЬ'],\r\n        labels: {\r\n            style: {\r\n                colors: '#8A8A8A',\r\n                fontSize: '14px',\r\n                fontFamily: 'Open Sans Cond',\r\n                fontWeight: 400,\r\n            },\r\n        },\r\n    },\r\n    yaxis: {\r\n        title: {\r\n            text: 'ДОХОД $',\r\n            rotate: 0,\r\n            offsetX: 15,\r\n            offsetY: -110,\r\n            style: {\r\n                color: '#8A8A8A',\r\n                fontSize: '16px',\r\n                fontFamily: 'Open Sans Cond',\r\n                fontWeight: 400,\r\n            },\r\n        },\r\n        labels: {\r\n            style: {\r\n                colors: '#8A8A8A',\r\n                fontSize: '14px',\r\n                fontFamily: 'Open Sans Cond',\r\n                fontWeight: 400,\r\n            },\r\n        },\r\n    },\r\n    fill: {\r\n        opacity: 1\r\n    },\r\n    tooltip: {\r\n        y: {\r\n            formatter: function (val) {\r\n                return \"$ \" + val\r\n            }\r\n        }\r\n    },\r\n    legend: {\r\n        position: 'top',\r\n        horizontalAlign: 'right',\r\n        fontSize: '14px',\r\n        fontFamily: 'Open Sans Cond',\r\n        fontWeight: 400,\r\n        labels: {\r\n            colors: '#8A8A8A',\r\n        },\r\n        markers: {\r\n            width: 12,\r\n            height: 12,\r\n            offsetX: -5,\r\n            offsetY: 1\r\n        },\r\n        itemMargin: {\r\n            horizontal: 15,\r\n        },\r\n    },\r\n    colors: ['#155EEF', '#D24C4D', '#64B161'],\r\n};\r\nvar dailyChart = new apexcharts__WEBPACK_IMPORTED_MODULE_2__(document.querySelector(\"#daily-chart\"), dailyChartOptions);\r\ndailyChart.render();\r\n\r\n// Распределение по комиссии\r\nvar comissionChartOptions = {\r\n    series: [44, 55, 41, 17],\r\n    labels: [\r\n        '0$ - 10$',\r\n        '10$ - 20$',\r\n        '20$ - 100$',\r\n        '100$+',\r\n    ],\r\n    chart: {\r\n        type: 'donut',\r\n        height: '100%',\r\n    },\r\n    stroke: {\r\n        colors: '#000',\r\n        width: 0,\r\n    },\r\n    plotOptions: {\r\n        pie: {\r\n            startAngle: 0,\r\n            endAngle: 360,\r\n            customScale: 1.2,\r\n            offsetY: 100,\r\n            donut: {\r\n                size: '80%',\r\n                labels: {\r\n                    show: true,\r\n                    total: {\r\n                        show: true,\r\n                        showAlways: true,\r\n                        fontSize: '22px',\r\n                        fontFamily: 'Open Sans Cond',\r\n                        fontWeight: 700,\r\n                        color: '#fff',\r\n                        label: 'Итого',\r\n                        formatter: function (w) {\r\n                            return w.globals.seriesTotals.reduce((a, b) => {\r\n                                return a + b\r\n                            }, 0)\r\n                        }\r\n                    }\r\n                }\r\n            },\r\n        }\r\n    },\r\n    legend: {\r\n        labels: {\r\n            colors: '#fff',\r\n        },\r\n        markers: {\r\n            width: 12,\r\n            height: 12,\r\n            offsetX: -5,\r\n            offsetY: 1,\r\n            radius: 0,\r\n        },\r\n        offsetY: 65,\r\n        itemMargin: {\r\n            vertical: 5\r\n        },\r\n    },\r\n    colors: ['#155EEF', '#D24C4D', '#64B161', '#9747FF'],\r\n    dataLabels: {\r\n        enabled: false,\r\n    },\r\n};\r\nvar comissionChart = new apexcharts__WEBPACK_IMPORTED_MODULE_2__(document.querySelector(\"#comission-chart\"), comissionChartOptions);\r\ncomissionChart.render();\r\n\r\n// График количества рефералов\r\nvar refChartOptions = {\r\n    series: [{\r\n        name: \"Рефералы\",\r\n        data: [0, -1, -2, 0, 3, 1, 2, -1, 0, 1],\r\n    }],\r\n    chart: {\r\n        height: 250,\r\n        type: 'line',\r\n        zoom: {\r\n            enabled: false\r\n        },\r\n        toolbar: {\r\n            show: false,\r\n        }\r\n    },\r\n    dataLabels: {\r\n        enabled: false\r\n    },\r\n    stroke: {\r\n        curve: 'straight',\r\n        width: 3,\r\n        colors: '#f7c911',\r\n    },\r\n    title: {\r\n        text: 'Кол-во чел.',\r\n        align: 'left',\r\n        style: {\r\n            color: '#8A8A8A',\r\n            fontSize: '16px',\r\n            fontFamily: 'Open Sans Cond',\r\n            fontWeight: 400,\r\n        },\r\n        offsetX: 10,\r\n        offsetY: 5,\r\n    },\r\n    grid: {\r\n        row: {\r\n            opacity: 0\r\n        },\r\n        column: {\r\n            opacity: 0\r\n        },\r\n    },\r\n    xaxis: {\r\n        categories: ['10.06', '11.06', '12.06', '13.06', '14.06', '15.06', '15.06', '16.06', '17.06', '18.06'],\r\n        labels: {\r\n            style: {\r\n                colors: '#8A8A8A',\r\n                fontSize: '14px',\r\n                fontFamily: 'Open Sans Cond',\r\n                fontWeight: 400,\r\n            },\r\n        },\r\n    },\r\n    yaxis: {\r\n        categories: [0, -1, -2, 0, 1, 1, 2, 2, 0, 1],\r\n        labels: {\r\n            style: {\r\n                colors: '#8A8A8A',\r\n                fontSize: '13px',\r\n                fontFamily: 'Open Sans Cond',\r\n                fontWeight: 400,\r\n            },\r\n        },\r\n    },\r\n};\r\nvar refChart = new apexcharts__WEBPACK_IMPORTED_MODULE_2__(document.querySelector(\"#ref-chart\"), refChartOptions);\r\nrefChart.render();\r\n\r\n\r\nfunction totalEdit() {\r\n    const total = document.querySelector('#comission-chart .apexcharts-datalabel-value');\r\n    if (total) {\r\n        total.style.fontFamily = 'Open Sans, sans-serif';\r\n        total.style.fontSize = '32px';\r\n        total.style.fontWeight = 700;\r\n        total.style.fill = '#fff';\r\n\r\n        document.querySelector('#comission-chart .apexcharts-datalabel-label').remove();\r\n        document.querySelector('#comission-chart .apexcharts-datalabels-group').style.transform = 'translateY(-28px)';\r\n    }\r\n}\r\ntotalEdit();\r\n\r\nwindow.addEventListener('resize', () => {\r\n    appHeight();\r\n});\r\n\r\nfunction loadFile(loadBtn) {\r\n    loadBtn.parentElement.querySelector('input[type=\"file\"]').click();\r\n}\r\n\r\nfunction menuShowHide(menuBtn) {\r\n    const menu = document.querySelector('.menu-header');\r\n    if (!menuBtn.classList.contains('_active')) {\r\n        menuBtn.classList.add('_active');\r\n        menu.classList.add('_active');\r\n    } else {\r\n        menuBtn.classList.remove('_active');\r\n        menu.classList.remove('_active');\r\n    }\r\n}\r\n\r\nfunction closeAll() {\r\n    const active = document.querySelectorAll('._active');\r\n\r\n    if (active.length) {\r\n        active.forEach((el) => {\r\n            el.classList.remove('_active');\r\n        });\r\n    }\r\n}\r\n\r\nfunction passShowHide(passBtn) {\r\n    if (!passBtn.classList.contains('active')) {\r\n        passBtn.classList.add('active');\r\n        passBtn.previousElementSibling.setAttribute('type', 'text');\r\n    } else {\r\n        passBtn.classList.remove('active');\r\n        passBtn.previousElementSibling.setAttribute('type', 'password');\r\n    }\r\n}\r\n\r\ndocument.addEventListener('click', (e) => {\r\n    const loadBtn = e.target.closest('.load__btn_file');\r\n    if (loadBtn) {\r\n        loadFile(loadBtn);\r\n    }\r\n\r\n    const menuBtn = e.target.closest('.header__menu-icon');\r\n    if (menuBtn) {\r\n        menuShowHide(menuBtn);\r\n    } else {\r\n        closeAll();\r\n    }\r\n\r\n    const passBtn = e.target.closest('.login__pass');\r\n    if (passBtn) {\r\n        passShowHide(passBtn);\r\n    }\r\n});\n\n//# sourceURL=webpack://Project/./src/js/app.js?");
